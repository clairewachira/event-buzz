    ...
    <div class="card mt-5 w-50">
        <div class="card-body">
            ...
            <div class="alert alert-warning p-4 mb-4 rounded">
                <p>A prompt to confirm this deposit shall be sent to your mobile phone.</p>
                <p>Allowed phone number formats are strictly: </p>
                <p> <b>2547XXXXXXXX or 2541XXXXXXXX </b> </p>
                <p> (Do not use <b>+ sign</b>)</p>
            </div>
            ...
            <form id="paymentForm">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="number" id="amount" name="amount" placeholder="Enter amount" required class="form-control" value="<?= esc($booking['amountPaid']) ?>" readonly>
                </div>

                <button type="submit" id="makePayment" class="btn btn-success btn-block">
                    Enter Deposit Amount(ksh) 
                </button>
