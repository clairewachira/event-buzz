    ...
    <?php if (session()->has('user_type')): ?>
		  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="loginDropdown">
						...
						<a class="dropdown-item" href="/auth/<?= (session()->get('user_type')) ?>/logout">logout</a>
                    </div>
                </li>
    <?php else: ?>
		  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="loginDropdown">
                        ...
                        <a class="dropdown-item" href="/auth/admin/login">Administrator</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="registerDropdown">
                        ...
                        <a class="dropdown-item" href="/auth/admin/register">Administrator</a>
                    </div>
                </li>
    <?php endif; ?>
        </ul>
